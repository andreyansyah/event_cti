! function($) {
    ...
    FlotChart.prototype.createPlotGraph = function(selector, data1, data2, data3, labels, colors, borderColor, bgColor) {
        ...
        FlotChart.prototype.init = function() {
            ...
            var pcolors = ['#f0f1f4', '#04b1c7', '#ed7f22'];
            ...
            var datas = [20, 30, 15];
            var colors = ['#04b1c7', '#ed7f22', "#ebeff2"];
            this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#aec936']);
            plot.draw();
            var $this = this;
            ...
            var donutcolors = ['#f0f1f4', '#04b1c7', '#aec936'];
